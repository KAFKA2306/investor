...
const naiveMetrics = { mae: 1, rmse: 1, da: 100 };
const resultsByModel: Record<string, { mae: number; rmse: number; da: number }> = { chronos: { mae: 1, rmse: 1, da: 100 } };
...
const benchmarkLog = {
    ...
    report: {
        ...
        debugger: { telemetry: {}, envCheck: { python_venv: true, uv_installed: true }, rawValues: [1], latencyMs: 100 }
    }
};
