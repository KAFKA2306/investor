...
function exportPlotData(logsBaseDir: string) {
    ...
    const rows: string[] = ["Timestamp,CumReturn,Drawdown,FactorValue,Volatility,AssetPrice,Position"];
    let cumReturn = 0;
    let runningMax = 0;
    ...
    for (const file of files) {
        ...
        rows.push(`${date},${cumReturn},${drawdown},${factorValue},${volatility},${assetPrice},${position}`);
    }
