...
export function calculateFractionalKelly(p: number, decimalOdds: number, alpha: number): number {
...
export function updateBayesian(prior: number, likelihood: number, evidence: number): number {
